...
textref = 20;
windowref_y = 1440; % we want some thing that correpond to a size of 30 on a screen with a y of 1536
...
DrawFormattedText(var.w, instructionText, 'center', 'center', [0 0 0], 60,[],[],2)
