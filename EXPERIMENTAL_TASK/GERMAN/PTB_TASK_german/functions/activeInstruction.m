...
%**************************************************************************
    ...
    function [] = Instructions_MP_2  (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.basicScreen , 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2);% explain text
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_3  (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.aFractal, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2);% explain text
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_4  (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.yellowBoxes, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2);% explain text
        Screen('Flip',var.w);
        Screen('Close', fractal_text);
    ...
    function [] = Instructions_MP_5  (instrDisp, text, position, var)
        ...
        points =  [ head-[instrDisp.triangle,0]              % left corner
            ...
            head+[0,instrDisp.triangle] ];                   % vertex
        Screen('FillPoly', var.w,[200 0 0], points);
        DrawFormattedText(var.w, text.buttonWorks , 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2);
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_6  (instrDisp, text, position, var)
        ...
        Screen('FrameRect', var.w, var.allColors, position.allRectsV, instrDisp.gridThick); % reponse grid
        DrawFormattedText(var.w, text.eachBox, 'center', 'center', [0 0 0], 80);
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_7  (instrDisp, text, position, var)
        ...
        boxButtonText = fileread('instructions/boxButton.txt');
        buttonNextRepeatText = fileread('instructions/buttonNextRepeat.txt');
        ...
        for ii = 1: length(squares)
            ...
            message = [boxButtonText ': \n' '  ' buttonX '   '];
            DrawFormattedText(var.w, message, 'center', 'center', [0 0 0], 80,false, false, 1.2);
            Screen('Flip',var.w);
            WaitSecs (var.instructionSpeed);
            
        end
        
       DrawFormattedText(var.w, buttonNextRepeatText, 'center', 'center', [0 0 0], 80, [], [], 1.2);
       Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_8  (instrDisp, text, position, var)
        ...
        % General
        DrawFormattedText(var.w, text.letsPractice, 'center', 'center', [0 0 0], 80, [], [], 1.2);
        Screen('Flip',var.w);
        WaitSecs (2);
        ...
        for ii = 1: length(squares)
            ...
            incorrectResponseText = importdata('instructions/incorrectResponse.txt');
            goodJobText = importdata('instructions/goodJobNext.txt');
            
            while ~correctPressed
                position_response_cue = CenterRectOnPointd([0 0 var.CUEdim var.CUEdim],squareX, var.yUpper);
                Screen('FrameRect', var.w, var.allColors, position.allRectsV, instrDisp.gridThick); % reponse grid
                Screen('FillRect', var.w, [250; 250; 0], position_response_cue);   % response cue
                DrawFormattedText(var.w, text.pleasePress, 'center', 'center', [0 0 0], 80, [], [], 1.2);
                Screen('Flip',var.w);
                ...
                if (keyPressed == 1) && ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, 'Correct ', 'center', 'center', [0 120 0], 80, [], [], 1.2);
                    Screen('Flip',var.w);
                    WaitSecs(2);
                    correctPressed = 1;
                ...
                elseif (keyPressed == 1) && ~ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, [incorrectResponseText{1} '\n' '   ' num2str(buttonX) '   ' '\n' incorrectResponseText{2}], 'center', 'center', [200 0 0], 80, [], [], 1.2);
                    Screen('Flip',var.w);
                    WaitSecs(2);
                    correctPressed = 0;
        ...
        DrawFormattedText(var.w, [goodJobText{1} '\n' goodJobText{2}], 'center', 'center', [0 0 0], 80, [], [], 1.2);
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_9  (instrDisp, text, position, var)
        % say there are two kind of blocks
    ...
    function [] = Instructions_MP_10 (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.duringRespond, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2);
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_11 (instrDisp, text, position, var)
        ...
        points =  [ head+[instrDisp.triangle,0]              % left corner
            ...
            head-[0,instrDisp.triangle] ];                   % vertex
        Screen('FillPoly', var.w,[200 0 0], points);
        DrawFormattedText(var.w, text.circleAppear, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2);
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_12 (instrDisp, text, position, var)
        ...
        Screen('FrameRect', var.w, var.allColors, position.allRectsV, instrDisp.gridThick); % reponse grid
        Screen('FillRect', var.w, var.allColors(:,1),   position_response_cue, instrDisp.gridThick); % lit
        DrawFormattedText(var.w, text.wrongPress, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2);
    ...
    function [] = Instructions_MP_13 (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.sometimesReward, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2); % explain text
        Screen('Flip',var.w);
        WaitSecs(var.instructionSpeed);
    ...
    function [] = Instructions_MP_14 (instrDisp, text, position, var)
        ...
        Screen('DrawTexture', var.w, sweet_text ,[], position.Reward ); % sweet picture
        DrawFormattedText(var.w, text.pictureMeans , 'center', 'center', [0 0 0], 80, [], [], 1.2); % explain text
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_17 (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.duringRest, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2); % explain text
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_18 (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.relax, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2); % explain text  %LATER WRAP
        Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_19 (instrDisp, text, position, var)
        ...
        restRespondText = importdata('instructions/restRespondQuestion.txt');
        goodJobText = importdata('instructions/goodJobNext.txt');
        ...
        % message
        text.restoractive = [restRespondText{1} KbName(var.rightKey(1)) '  ' '\n' restRespondText{2} KbName(var.leftKey(1)) ' '];
        ...
        conName   = {restRespondText{3}; restRespondText{4}};
        ...
        for ii = 1:length(condition)
            ...
            while ~correctPressed
                ...
                DrawFormattedText(var.w, text.restoractive, 'center', var.yLowerLow, [0 0 0], 80, [], [], 1.2); % explain text
                Screen('Flip',var.w);
                ...
                if (keyPressed == 1) && ismember(respKey, codeX) % correct
                    ...
                    DrawFormattedText(var.w, restRespondText{5}, 'center', var.yLowerLow, [0 120 0], 80, [], [], 1.2); % explain text
                    Screen('Flip',var.w);
                ...
                elseif (keyPressed == 1) && ~ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, [restRespondText{6} conNameX restRespondText{7} '\n' restRespondText{8}], 'center', var.yLowerLow, [200 0 0], 80, [], [], 1.2); % explain text
                    Screen('Flip',var.w);
    ...
    function [] = Instructions_MP_20 (instrDisp, text, position, var)
        ...
        fractal_text  = Screen('MakeTexture',var.w, instrDisp.fractal);
        Screen('DrawTexture', var.w, fractal_text ,[], position.Fractal); % draw fractal
        DrawFormattedText(var.w, text.multipleFractal, 'center', var.yUpper, [0 0 0], 80, [], [], 1.2); % explain text 
        head   = [var.xCenter, var.yLower];                  % coordinates of head                        
        points =  [ head+[instrDisp.triangle,0]              % left corner
            head-[instrDisp.triangle,0]                      % right corner
            head-[0,instrDisp.triangle] ];                   % vertex
    ...
    function [] = Instructions_MP_21 (instrDisp, text, position, var)
        ...
        DrawFormattedText(var.w, text.Fractalmeans , 'center', var.yUpper, [0 0 0], 80, [], [], 1.2); 
        Screen('Flip',var.w);
